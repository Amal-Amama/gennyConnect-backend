...
export class MatchingService {
  ...
  async matchTechnicians(
    ...
    for (const technician of technicians) {
      ...
      // Étape 2: Calculer la distance et filtrer les techniciens
      const locationTech = technician.location;
      const maintenanceLocation = maintenanceRequest.maintenanceLocation;
      ...
      if (distance < 30) {
        technician.assignedRequestsToTech.push(maintenanceRequest._id);
        await technician.save();
        ...
        console.log('This request is not suitable for any of our technicians');
      }
    }
